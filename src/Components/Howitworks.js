...
const Howitworks = () => {
  return (
    <section className='how-it-works-section'>
        <h2 className='text-4xl h2'>ჩვენი სერვისი</h2>
    ...
    <div className="relative bg-gray-800" style={{marginTop:'50px'}}>
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="md:ml-auto md:w-1/2 md:pl-10">
          ...
          კანალიზაციის ქსელის შეკეთება-გაწმენდა მსუბუქი, კომპაქტური და მოხერხებული მანქანით: იდეალურია კანალიზაციის მილებსა და სველ წერტილებში საცობების გასაწმენდად  
          </p>
          <div className="mt-8">
